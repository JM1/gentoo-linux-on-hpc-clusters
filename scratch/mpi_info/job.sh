...
export LD_LIBRARY_PATH=$HOME/gentoo/usr/lib64/:$HOME/gentoo/usr/lib64/binutils/x86_64-pc-linux-gnu/2.32/
mpirun --mca mpi_show_mca_params all --mca mpi_show_mca_params_file 'mca_params.txt' ./a.out
